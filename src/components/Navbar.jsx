    ...
    <header className=" w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.div className="relative group w-7 mr-4">
            <motion.a
              href="https://github.com/Mubisherali"
              target="_blank"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="block w-full"
          ...
          <motion.div className="relative group w-7 mr-4">
            <motion.a
              href="https://www.fiverr.com/mubisher_123/buying?source=avatar_menu_profile"
              target="_blank"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="block w-full"
      ...
      {isOpen ? (
        ...
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            <motion.a
              href={"https://www.linkedin.com/in/mudassar-rana-787971235/"}
              target="_blank"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
            ...
            <motion.a
              href={"https://github.com/Mudassar-1"}
              target="_blank"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
